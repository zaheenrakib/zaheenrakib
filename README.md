...
- 🔭 **Currently working on:**  
  Full-stack web applications using **Next.js, React, Node.js**, and modern UI frameworks.

- 👯 **Looking to collaborate on:**  
  Open-source projects, SaaS apps, dashboards, and real-world web applications.

- 🤝 **Looking for help with:**  
  System design, performance optimization, and scalable backend architecture.

- 🌱 **Currently learning:**  
  Advanced **Next.js (App Router)**, **TypeScript**, **Prisma**, and **PostgreSQL**.

- 💬 **Ask me about:**  
  Next.js, React, Tailwind CSS, REST APIs, authentication (JWT), and full-stack architecture.
...
![React Suite](https://img.shields.io/badge/React_Suite-248EED?style=flat&logo=react&logoColor=white)
